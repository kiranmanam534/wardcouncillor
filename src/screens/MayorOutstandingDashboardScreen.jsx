      ...
      navigation.navigate('AllWards', {
        title:
          loggedUser?.warD_NO != 0
            ? loggedUser?.warD_NO +
              ' - ' +
              GetwardHeaderTitle('Outstanding', 'All Wards Outstanding')
            : GetwardHeaderTitle('Outstanding', 'All Wards Outstanding'),
      ...
      navigation.navigate('CouncillorDetails', {
        title:
          loggedUser?.warD_NO != 0
            ? loggedUser?.warD_NO +
              ' - ' +
              GetwardHeaderTitle('Outstanding', 'Outstanding Ward Summary')
            : GetwardHeaderTitle('Outstanding', 'Outstanding Ward Summary'),
        wardType: 'Outstanding',
      });
      ...
      navigation.navigate('CategoryOutstanding', {
        title:
          loggedUser?.warD_NO != 0
            ? loggedUser?.warD_NO +
              ' - ' +
              GetwardHeaderTitle('Outstanding', 'Outstanding Categories')
            : GetwardHeaderTitle('Outstanding', 'Outstanding Categories'),
    ...
    <View style={styles.wrapper}>
      <ScrollView
        ...
        <View style={styles.container}>
          {MayorOustandingDashboardList.map((item, index) => (
            <Animated.View
              key={item.id}
              style={[
                {
