...
import { CollectionsDashboardList, MayorOustandingDashboardList } from '../constant/MainDashboardList'
    ...
    const handleDetailsNavigation = (item) => {
        ...
        if (item.name == 'WardCollections') {
            navigation.navigate("WardWiseCollections", {
                title: loggedUser?.warD_NO != 0 ? loggedUser?.warD_NO + ' - ' + GetwardHeaderTitle("Collections", "Ward wise collections") : GetwardHeaderTitle("Collections", "Ward wise collections"),
