        ...
        <Card style={styles.card}>
          <Card.Content style={{ paddingRight: 80 }}>
            <View style={{ flexDirection: 'row', paddingTop: 10 }}>
              ...
              <Text
                style={{ fontWeight: '500', fontSize: 15, color: Colors.black }}>
                : {item.roadclouseR_STARTDATE} {item.roadclouseR_STARTTIME}
              </Text>
            </View>
            <View style={{ flexDirection: 'row', paddingTop: 10 }}>
          ...
          <Card.Content
            ...
            <View style={{ marginTop: 15 }}>
              <TouchableOpacity
                onPress={() => { onPress('Edit', 'Edit Road Closure', 'RoadClouser', "RoadClouser", item) }}
                style={[
                  styles.btn,
                  {
                    height: 30,
            ...
            <View style={{ marginTop: 15 }}>
              <TouchableOpacity
                onPress={() => {
                  deletedID != item.id &&
                    onPress('Delete', 'Road Clouser', '', "RoadClouser", item)
                }}
                style={[
                  styles.btn,
                  {
            ...
            <View style={{ marginTop: 15 }}>
              <TouchableOpacity
                onPress={() => { onPress('Images', 'Road Closure Images', 'ViewImages', "RoadClouser", item) }}
                style={[
                  styles.btn,
                  {
                    height: 30,
